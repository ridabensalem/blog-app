...
#   posts = Post.create([
#     {user_id: 1, title: 'Shadow clone jutsu', text: ' A technique that allows Naruto to create multiple copies of himself. The clones have their own consciousness and can perform various tasks.'},
#     {user_id: 1, title: 'Nine-Tailed Fox Chakra Mode', text: 'A powerful transformation that Naruto can access when he draws on the chakra of the Nine-Tailed Fox that was sealed inside him. In this mode, Naruto\'s power and speed are greatly increased.'},
#     {user_id: 2, title: 'Chidori', text: 'A powerful ninjutsu technique that Sasuke learned from Kakashi Hatake. Chidori involves gathering lightning-based chakra in the user\'s hand, creating a piercing and lethal weapon.'},
#     {user_id: 3, title: 'Byakugan', text: 'A powerful dojutsu unique to the Hyuga clan. The Byakugan grants Hinata near 360-degree vision, allowing her to see through solid objects and predict the movements of her opponents.'},
#     {user_id: 5, title: 'Strength of a Hundred Seal', text: 'A powerful medical ninjutsu technique that Sakura learns from Tsunade, the Fifth Hokage. The Strength of a Hundred Seal temporarily enhances Sakura\'s physical abilities, making her much stronger and faster.'},
#     {user_id: 4, title: 'Sharingan', text: 'An advanced dojutsu that Kakashi possesses. The Sharingan allows him to copy other ninja\'s techniques, as well as provide enhanced perception and reaction time.'},
#     {user_id: 2, title: 'Falcon Punch', text: 'A powerful taijutsu technique that Sasuke learns from Orochimaru. The technique involves launching a powerful punch with enough force to knock the target away.'},
#     {user_id: 3, title: 'Protective Eight Trigrams Sixty-Four Palms', text: 'A defensive version of the Eight Trigrams Sixty-Four Palms technique. Hinata uses this technique to protect herself and her allies from harm.'}
#   ])
  
#   comments = Comment.create([
#     {user_id: 1, post_id: 1, text: 'My Hobby Is Eating Different Kinds Of Ramen And Comparing Them.'},
#     {user_id: 4, post_id: 2, text: 'Sorry I\'m Late Guys, I Got Lost On The Path Of Life.'},
#     {user_id: 5, post_id: 3, text: 'Run Into The Setting Sun. Run And Suffer. But Don\'t Mess Up Your Hair!'},
#     {user_id: 2, post_id: 5, text: 'What Adult Goes Full Force While Fighting Mere Children?'},
#     {user_id: 3, post_id: 4, text: 'I Am Not A Pervert, I Am A Super Pervert!'}
#   ])
